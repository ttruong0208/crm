...
async function applySchemaStatements(statements) {
...
async function initDb() {
  ...
  await applySchemaStatements(CRM_SCHEMA_STATEMENTS);
  await finalizeUserDefaults();
  if (!(await tableExists("users"))) {
    throw new Error("Không tạo được bảng users — kiểm tra DATABASE_URL Neon");
  }
}
